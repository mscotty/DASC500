...
# Importing the all the stats functions from DASC500.stats
...
if __name__ == "__main__":
    # Safeguard to help prevent plt.show() from blocking tests
    original_show = plt.show
    plt.show = lambda: None  # Suppress plt.show() during tests

    # Wrapped the unittest call to restore plt.show() after the tests were complete
    try:
        unittest.main()
    finally:
